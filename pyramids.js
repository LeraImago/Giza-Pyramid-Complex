...
function init() {
    ...
    var areaLight1 = new THREE.RectAreaLight( 0x6717C2, intensity,  width, height );
	...
	let textureMoon = new THREE.TextureLoader().load('pic/moon.jpg');
	...
	let texturePyramid = new THREE.TextureLoader().load('pic/stone1.png');
